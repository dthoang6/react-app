...
function HomeGuest() {
  //using state to store the change of username, email, pass from the form
  const [username, setUsername] = useState();
  const [email, setEmail] = useState();
  const [password, setPassword] = useState();

  //handle submit by sending a request form from the frontend to database using Axios library, asyn function
